...
print(time.localtime()); \
print(time.time()-t0);" \
print("Time Taken for 8 Channels (in Hours, Minutes and Seconds: "); \
from time import gmtime; \
from time import strftime; \
print(strftime("%H:%M:%S", gmtime(time.time()-t0)))

aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:841635654721:awsnotify --message "JobDone"
